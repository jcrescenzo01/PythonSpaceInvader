...
while running:      # infinite loop so it stays open, but it will hang if theres no quit functionality!
    ...
    # playerX+=0.05     # would move the player right, -= would do left
    # print(playerX)    # continually increasing
    ...
    player(playerX, playerY)    # called after screen.fill since we want player on top of screen, opposite would draw it underneath
